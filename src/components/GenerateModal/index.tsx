          ...
          <>
            <S.InputArea>
              ...
              <Input
                ...
                value={userInput.moods}
                onChange={(e) => handleInputChange('moods', e.target.value)}
                onKeyPress={(e) =>
            ...
            <S.InputArea>
              ...
              <Input
                ...
                value={userInput.coops}
                onChange={(e) => handleInputChange('coops', e.target.value)}
                onKeyPress={(e) =>
